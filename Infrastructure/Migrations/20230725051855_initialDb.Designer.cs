...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230725051855_initialDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.MenuAggregate.MenuModel", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Domain.MenuAggregate.MenuModel", b =>
                {
                    ...
                    b.OwnsMany("Domain.MenuAggregate.Entities.MenuSection", "Sections", b1 =>
                        {
                            ...
                            b1.OwnsMany("Domain.MenuAggregate.Entities.MenuItem", "MenuItems", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .HasColumnType("uniqueidentifier")
                    ...
                    b.OwnsMany("Domain.MenuAggregateReview.ValueObjects.MenuReviewId", "MenuReviewIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("Domain.Common.ValueObjects.AverageRating", "AverageRating", b1 =>
                        {
                            b1.Property<Guid>("MenuModelId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("NumberRatings")
                                .HasColumnType("int");

                            b1.Property<double>("Value")
                                .HasColumnType("float");

                            b1.HasKey("MenuModelId");
